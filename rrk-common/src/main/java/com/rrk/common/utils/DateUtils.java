...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	...
	public final static String DATE_TIME_PATTERN_AL = "YYYYMMDDHHMMSS";
	public final static String DATE_TIME_PAT = "yyyy-MM-dd";
	/**
	 * 一小时的秒数
	 */
...
//			}
	...
	public static List<String> getPartTimeList(int time, String formate) {
		List<String> list = new ArrayList<>();
		for (int i = time; i > 0; i--) {
			//过去几天内的时间集合
			list.add(getPastDate(i, formate));
			//fetureDaysList.add(getFetureDate(i));//未来几天的时间集合
		}
		return list;
	}
	 ...
	 *
	 * @param past    过去第几天 7
	 * @param formate 日期格式 yyyy-MM-dd
	 * @return
	 */
	public static String getPastDate(int past, String formate) {
